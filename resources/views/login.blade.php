...
<body class="antialiased min-h-screen overflow-x-hidden flex flex-col lg:flex-row">
  ...
  <div class="hidden lg:flex w-full lg:w-1/2 min-h-screen bg-emerald-600 relative overflow-hidden flex-col justify-between p-12">
    ...
    <div class="relative z-10 space-y-8">
      ...
      <div class="bg-white/10 backdrop-blur-md border border-white/10 rounded-sm p-6 max-w-md fade-in-anim fade-in-delay-2">
        ...
        <p class="text-sm text-emerald-100/80 font-light leading-relaxed">"ቅድሚያ ለጤናዎ helped me reduce my missed medications by 90%. I feel more in control of my recovery."</p>
    ...
    <div class="relative z-10 text-xs text-emerald-200/50">
      © 2025 ቅድሚያ ለጤናዎ Health Systems. All rights reserved.
    </div>
  </div>
  ...
  <div class="w-full lg:w-1/2 min-h-screen flex flex-col justify-center items-center px-6 sm:px-12 py-12 bg-white relative overflow-y-auto">
    ...
    <div class="w-full max-w-md relative z-10">
      ...
      <div class="mb-10">
        <h1 class="text-3xl sm:text-4xl font-medium tracking-tight text-slate-900 mb-3 fade-in-anim">Welcome back</h1>
      ...
      <form method="POST" action="{{ url('/login') }}" class="space-y-5 fade-in-anim fade-in-delay-2">
        @csrf

        @if ($errors->any())
          <div class="bg-red-50 border border-red-200 text-red-700 rounded-sm p-3 text-sm">
            {{ $errors->first() }}
          </div>
        @endif

        <div>
          <label class="text-xs font-medium text-slate-500 uppercase tracking-wider mb-2 block">Email or Phone</label>
          <div class="relative">
            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
              <i class="fa-regular fa-user text-slate-300 text-sm"></i>
            </div>
            <input
              type="text"
              id="identifier"
              ...
              placeholder="email@domain.com OR +2519..."
              required
              class="w-full bg-white border border-slate-200 focus:border-emerald-300 focus:ring-2 focus:ring-emerald-100 rounded-sm pl-11 pr-4 py-3 text-sm text-slate-900 placeholder-slate-300 outline-none transition-all duration-300"
            >
          </div>
        </div>
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input
              ...
              required
              class="w-full bg-white border border-slate-200 focus:border-emerald-300 focus:ring-2 focus:ring-emerald-100 rounded-sm pl-11 pr-12 py-3 text-sm text-slate-900 placeholder-slate-300 outline-none transition-all duration-300"
            >
        ...
        <div class="flex items-center justify-between">
          ...
          <a href="#" class="text-sm font-medium text-emerald-600 hover:text-emerald-700 transition-colors hover:underline">Forgot password?</a>
        </div>
